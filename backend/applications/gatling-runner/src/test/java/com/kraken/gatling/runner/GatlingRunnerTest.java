...
public class GatlingRunnerTest {
  ...
  public void before() {
    ...
    gatlingRunnerProperties = GatlingRunnerPropertiesTest.GATLING_PROPERTIES;
    runner = new GatlingRunner(storageClient,
        runtimeClient,
        commandService,
        containerProperties,
        gatlingRunnerProperties,
        commandSupplier);
  }
  ...
  public void shouldPassTestUtils() {
    new NullPointerTester()
        ...
        .setDefault(GatlingRunnerProperties.class, gatlingRunnerProperties)
