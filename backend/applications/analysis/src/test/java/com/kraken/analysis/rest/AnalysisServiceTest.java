...
import static com.kraken.analysis.AnalysisPropertiesTest.ANALYSIS_PROPERTIES;
...
public class AnalysisServiceTest {
  ...
  @Before
  public void before() {
    service = new AnalysisService(ANALYSIS_PROPERTIES,
  ...
  public void shouldRun() {
    ...
    assertThat(command.getPath()).isEqualTo(ANALYSIS_PROPERTIES.getRunProperties().getRoot());
  ...
  public void shouldDebug() {
    ...
    final Command command = commandCaptor.getValue();
    assertThat(command.getApplicationId()).isEqualTo(applicationId);
    assertThat(command.getPath()).isEqualTo(ANALYSIS_PROPERTIES.getDebugProperties().getRoot());
  ...
  public void shouldRecord() {
    ...
    final Command command = commandCaptor.getValue();
    assertThat(command.getApplicationId()).isEqualTo(applicationId);
    assertThat(command.getPath()).isEqualTo(ANALYSIS_PROPERTIES.getRecordProperties().getRoot());
