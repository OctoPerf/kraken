...
public class StringToContainerTest {
  ...
  public void shouldConvert(){
    final var container = stringToContainer.apply("6ea1e79088d9;container_one_READY;2019-09-03 11:11:11 +0200 CEST;taskId;RUN;containerOneId;groupId;Container One;Some description; test!");
  ...
  public void shouldConvertDateFail(){
    ...
    final var container = stringToContainer.apply("fd6c4a0fb80d;container_three_STARTING;Ca va fail!!!;taskIdBis;RUN;containerThreeId;groupId;name;description");
