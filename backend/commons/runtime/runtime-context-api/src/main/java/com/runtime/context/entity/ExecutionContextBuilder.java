...
public class ExecutionContextBuilder {
  ...
  public ExecutionContextBuilder withGlobalEnvironmentVariable(final String key, final String value) {
  ...
  public ExecutionContextBuilder withHostEnvironmentVariable(final String hostId, final String key, final String value) {
  ...
  private ExecutionContextBuilder withHostEnvironment(final String hostId, Map<String, String> hostEnvironment) {
