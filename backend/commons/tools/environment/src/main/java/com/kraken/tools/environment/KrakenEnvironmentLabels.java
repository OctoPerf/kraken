...
public interface KrakenEnvironmentLabels {
  ...
  String COM_KRAKEN_HOST_ID = "sses";
  ...
  String COM_KRAKEN_STATUS = "com.kraken/status.%s";
  String COM_KRAKEN_CONTAINER_NAME = "com.kraken/containerName";
  String COM_KRAKEN_LABEL= "com.kraken/label";
