...
public class KeycloakSecurityAdminClientIntegrationTest {
  ...
  @Autowired
  Mono<SecurityAdminClient> client;

  @Test
  public void shouldGetUser() {
    final var krakenUser = client.flatMap(c -> c.getUser("2e44ffae-111c-4f59-ae2b-65000de6f7b7")).block();
  ...
  public void shouldSetUser() {
    final var krakenUser = client.flatMap(c -> c.getUser("73c523b5-6df6-4bca-9ea9-a97adfd8ef93")).block();
    assertThat(krakenUser).isNotNull();
    System.out.println(krakenUser);
    ...
    client.flatMap(c -> c.setUser(krakenUser.withAttributes(attributes))).block();
  }
}