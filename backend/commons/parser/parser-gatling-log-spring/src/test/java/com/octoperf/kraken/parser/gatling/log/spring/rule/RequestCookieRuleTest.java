...
public class RequestCookieRuleTest extends RuleTest<RequestCookieRule> {

  @Autowired
  RequestCookieRule rule;
  ...
  public void shouldAccept() {
    ...
    verify(context).appendRequestCookie("line");
  }
  ...
  public void shouldTestStates() {
    ...
    assertThat(rule.test("")).isFalse();
    given(context.getSubState()).willReturn(LogParserSubState.COOKIES);
