...
@AllArgsConstructor
final class ResponseHeaderRule implements ContentParserRule {
  ...
  public Optional<DebugEntry> apply(final String line) {
    parserContext.appendResponseHeader(line);
    return Optional.empty();
  }

  @Override
  public boolean test(final String line) {
    return parserContext.getState() == LogParserState.HTTP_RESPONSE && parserContext.getSubState() == LogParserSubState.HEADERS;
  }
