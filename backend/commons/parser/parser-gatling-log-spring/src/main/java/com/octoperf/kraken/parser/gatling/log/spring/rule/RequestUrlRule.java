...
@AllArgsConstructor
final class RequestUrlRule implements ContentParserRule {
  ...
  public Optional<DebugEntry> apply(final String line) {
    parserContext.getChunkBuilder().requestUrl(line);
    return Optional.empty();
  }

  @Override
  public boolean test(final String line) {
    return parserContext.getState() == LogParserState.HTTP_REQUEST && parserContext.getSubState() == LogParserSubState.NONE;
  }
