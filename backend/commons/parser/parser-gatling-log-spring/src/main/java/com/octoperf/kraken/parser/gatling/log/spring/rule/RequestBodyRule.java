...
@AllArgsConstructor
final class RequestBodyRule implements ContentParserRule {
  ...
  public Optional<DebugEntry> apply(final String line) {
    parserContext.appendRequestBody(line);
    return Optional.empty();
  }

  @Override
  public boolean test(final String line) {
    return parserContext.getState() == LogParserState.HTTP_REQUEST && parserContext.getSubState() == LogParserSubState.BODY;
  }
