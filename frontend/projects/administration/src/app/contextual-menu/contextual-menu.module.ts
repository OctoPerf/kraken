...
import {ExecuteShellMenuItemComponent} from 'projects/administration/src/app/contextual-menu/execute-shell-menu-item/execute-shell-menu-item.component';
...
@NgModule({
  declarations: [AdministrationContextualMenuComponent, ExecuteShellMenuItemComponent, ExecuteScriptMenuItemComponent],
